...
id: opsx-propose
category: Workflow
description: Propose a new change - branch, artifacts, and first commit in one step
---
...
- Prompt: "Run `/opsx:apply` to implement; a pull request is opened when all tasks are done."
